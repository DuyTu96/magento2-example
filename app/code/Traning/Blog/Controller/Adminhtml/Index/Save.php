...
{
    const EVENT_NAME = 'Training_Blog_controller_adminhtml_post_save';
    ...
    public function execute()
    {
        ...
        $data = $this->getRequest()->getBlogValue();
        ...
        if ($data) {
            ...
            try {
                ...
                $this->dataPersistor->clear('blogs');
            ...
            $this->dataPersistor->set('blogs', $data);
