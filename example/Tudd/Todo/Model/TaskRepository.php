...
use Exception;
use Tudd\Todo\Api\Data\TaskInterface;
use Tudd\Todo\Api\Data\TaskInterfaceFactory;
use Tudd\Todo\Api\Data\TaskSearchResultsInterfaceFactory;
use Tudd\Todo\Api\TaskRepositoryInterface;
use Tudd\Todo\Model\ResourceModel\Task as ResourceTask;
use Tudd\Todo\Model\ResourceModel\Task\CollectionFactory as TaskCollectionFactory;
...
class TaskRepository implements TaskRepositoryInterface
{
    ...
    public function update(
        ...
        try {
            $this->resource->update($taskModel);
        } catch (Exception $exception) {
            throw new CouldNotSaveException(__(
                'Could not update the task: %1',
                $exception->getMessage()
            ));
        }
        return $taskModel->getDataModel();
